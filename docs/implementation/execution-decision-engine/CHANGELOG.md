...
- AI-IEP-004A.6: Added repository-only Execution Decision Engine documentation, fixtures, validation, and generated evidence for provider-neutral advisory decisioning.
