...
Rollback is source-control only. Revert A.9 service, scripts, dashboard-data artifacts, documentation, and package script changes. No database, object storage, Cloudflare, credential, provider, deployment, or migration rollback is required.
