...
Rollback is source-control only: remove A.10 module, scripts, generated reports, docs, package scripts, and status updates. No database, object storage, Cloudflare, credential, provider, deployment, or migration rollback is required.
