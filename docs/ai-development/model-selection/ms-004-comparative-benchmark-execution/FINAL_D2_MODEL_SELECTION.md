...
| safety.narrative_summary.presentation | google | gemini-3.7-flash | FINAL_MODEL_SELECTION_READY | PASS | 17562.625 | 0.000826 | 80 | Cheapest sufficient hard-gate-passing candidate under MS-002 policy; previously approved six selections are preserved unless evidence-integrity defects appear. | NONE | COMPLETE_FOR_SELECTION |
...
| driver.copilot.contextual_response | driver.copilot.contextual_response::gpt-5.6-luna | openai | gpt-5.6-luna | 8 | 0 | 0 | 8 | DISQUALIFIED | 2967.75 | 0.000414 | 0 |
...
| route.risk_explanation.presentation | route.risk_explanation.presentation::gemini-3.7-flash | google | gemini-3.7-flash | 0 | 8 | 0 | 0 | DISQUALIFIED | NONE | NONE | NONE |
| route.risk_explanation.presentation | route.risk_explanation.presentation::mistral-medium-3-5 | mistral | mistral-medium-3-5 | 8 | 0 | 8 | 0 | ELIGIBLE | 1656.25 | 0.002023 | 80 |
...
| safety.narrative_summary.presentation | safety.narrative_summary.presentation::claude-sonnet-5 | anthropic | claude-sonnet-5 | 8 | 0 | 3 | 5 | DISQUALIFIED | 6120 | 0.007739 | 30 |
| safety.narrative_summary.presentation | safety.narrative_summary.presentation::gemini-3.7-flash | google | gemini-3.7-flash | 8 | 0 | 8 | 0 | ELIGIBLE | 17562.625 | 0.000826 | 80 |
...
| Category | Count |
| --- | --- |
| currentMaterialFailure | 0 |
| nonMaterialProviderFailure | 35 |
| supersededPreCorrectionEvidence | 133 |

## Expansion Provider Failure Classification

| Capability | Candidate | Provider | Model | Error Code | Category | Quota Status | Retryability | Systematic | Material | Classification | Count |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| driver.copilot.contextual_response | driver.copilot.contextual_response::gemini-3.7-flash | google | gemini-3.7-flash | RESOURCE_EXHAUSTED | QUOTA_OR_RATE_LIMIT | FREE_TIER_REQUEST_QUOTA_EXHAUSTED_DURING_EXPANSION | RETRYABLE_PROVIDER_CONDITION | false | false | NON_MATERIAL_PROVIDER_FAILURE | 2 |
| route.risk_explanation.presentation | route.risk_explanation.presentation::gemini-3.7-flash | google | gemini-3.7-flash | RESOURCE_EXHAUSTED | QUOTA_OR_RATE_LIMIT | FREE_TIER_REQUEST_QUOTA_EXHAUSTED_DURING_EXPANSION | RETRYABLE_PROVIDER_CONDITION | true | false | NON_MATERIAL_PROVIDER_FAILURE | 8 |
...
| NON_MATERIAL_PROVIDER_FAILURE | 10 |
...
| --- | --- | --- |
| driver.copilot.contextual_response | NO_MORE_BENCHMARKING_REQUIRED | Persisted LIVE_HOSTED evidence contains a hard-gate-passing cheapest-sufficient candidate for this capability. |
| route.risk_explanation.presentation | NO_MORE_BENCHMARKING_REQUIRED | Persisted LIVE_HOSTED evidence contains a hard-gate-passing cheapest-sufficient candidate for this capability. |
| safety.narrative_summary.presentation | NO_MORE_BENCHMARKING_REQUIRED | Persisted LIVE_HOSTED evidence contains a hard-gate-passing cheapest-sufficient candidate for this capability. |
