...
const requiredRepositoryFragments = [
  ...
  'Item-level return quantities are required for every product on the truck.',
  'discrepancyItemCount',
  'confirmRouteInventoryCloseoutPrintForWarehouse',
  'item.delivered_quantity + item.added_quantity',
...
const requiredRouteFragments = [
  ...
  "router.post('/warehouse/return-inventory/prepare'",
  "router.put('/warehouse/return-inventory/confirm-print'",
  'warehouseEmployee: {',
